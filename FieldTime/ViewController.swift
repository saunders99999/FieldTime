...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var Players = [
        PlayerStat.init(name: "Anthony", totalField: 0, onTheField: 0, subbed: 0, enabled: true),
        PlayerStat.init(name: "Declan", totalField: 0, onTheField: 0, subbed: 0, enabled: true),
        ...
        PlayerStat.init(name: "Ryan", totalField: 0, onTheField: 0, subbed: 0, enabled: true),
        ...
        PlayerStat.init(name: "Wyatt", totalField: 0, onTheField: 0, subbed: 0, enabled: true),
        ...
        PlayerStat.init(name: "Sevi", totalField: 0, onTheField: 0, subbed: 0, enabled: true),
        PlayerStat.init(name: "Us", totalField: 0, onTheField: 0, subbed: 0, enabled: true),
        PlayerStat.init(name: "Them", totalField: 0, onTheField: 0, subbed: 0, enabled: true)
    ]
